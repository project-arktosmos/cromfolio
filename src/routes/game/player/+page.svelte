	...
	{:else if player && levelInfo}
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
					...
					<div class="card-body items-center text-center">
						...
						{#if isEditingName}
							<div class="flex w-full max-w-xs items-center gap-2">
								...
								<button class="btn btn-sm btn-ghost" onclick={cancelEditName}> Cancel </button>
							</div>
						{:else}
							<div class="flex items-center gap-2">
								<h2 class="text-2xl font-bold">{player.name}</h2>
								<button class="btn btn-ghost btn-xs" onclick={startEditingName} title="Edit name">
									<svg
						...
						<!-- Level Badge -->
						<div class="badge badge-primary badge-lg mt-2 px-4 py-3 text-lg">
			...
			<div class="space-y-6 lg:col-span-2">
						...
						<div class="mb-4 flex items-center justify-between">
							<div class="flex items-center gap-4">
								<div
									...
									style="--value:{levelInfo.progressPercent}; --size:5rem; --thickness:0.5rem;"
									role="progressbar"
								>
							...
							<div class="text-right">
								<p class="text-primary text-xl font-semibold">Level {levelInfo.level + 1}</p>
				...
				<!-- Stats Cards -->
				<div class="stats stats-vertical lg:stats-horizontal bg-base-200 w-full shadow">
					<div class="stat">
				...
				<div class="card bg-base-300 border-warning/30 border">
					<div class="card-body">
						...
						<p class="text-base-content/60 mb-4 text-sm">
							Use these controls to test the leveling system
						</p>
						...
						<div class="flex items-center justify-between">
							<div>
								<p class="text-error font-medium">Danger Zone</p>
								<p class="text-base-content/60 text-sm">Reset all player progress</p>
							</div>
							{#if showResetConfirm}
